...
Pod::Spec.new do |s|
  s.name             = 'BucketSDK'
  s.version          = '0.1.0'
  s.summary          = 'A short description of BucketSDK.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Ryan/BucketSDK'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Ryan' => 'ryan@buckettechnologies.com' }
  s.source           = { :git => 'https://github.com/Ryan/BucketSDK.git', :tag => s.version.to_s }
